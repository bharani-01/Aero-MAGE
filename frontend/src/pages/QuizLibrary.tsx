...
export default function QuizLibrary() {
  ...
  const [scopeFilter, setScopeFilter] = useState<'all' | 'public' | 'organization'>('all');
  ...
  const filteredQuizzes = quizzes.filter(quiz => {
    ...
    const matchesScope = scopeFilter === 'all' || quiz.visibility.toLowerCase() === scopeFilter.toLowerCase();
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex justify-between items-center">
          <h3 className="text-headline-sm font-extrabold text-on-surface">
            Discover Quizzes ({filteredQuizzes.length})
          </h3>
        </div>
                    ...
                    <div className="flex flex-col gap-3 border-t border-outline-variant/60 pt-3">
                      ...
                      <div className="flex items-center justify-between gap-2">
                        ...
                        <button
                          ...
                          className="bg-primary text-white hover:bg-primary/90 transition px-4 py-2 rounded-xl text-xs font-bold shadow flex items-center gap-1 active:scale-95 ml-auto"
                        >
