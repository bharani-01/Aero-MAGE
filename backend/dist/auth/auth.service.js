...
export const handleLogin = async (credentials, ipAddress, userAgent) => {
...
export const handleRefresh = async (refreshTokenStr, ipAddress, userAgent) => {
    if (!refreshTokenStr) {
...
// 4. Logout Service
export const handleLogout = async (refreshTokenStr) => {
    if (!refreshTokenStr)
        return;
    let decoded;
    try {
