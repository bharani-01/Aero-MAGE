...
async function seedRole(id, name, display_name, description, hierarchy_level, is_default = false) {
...
async function seedPermission(name, display_name, resource, action) {
...
async function linkPermission(roleId, permissionName) {
